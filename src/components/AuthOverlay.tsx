  ...
  const Register = () => {
    ...
    const handleRegister = async () => {
      ...
      await registerUser({
        ...
        console.log("Registration error", err.graphQLErrors);
      ...
      <Paper>
        ...
        >
          <Grid mt={20} mx="auto">
            ...
            <Col span={12}>
              <Center mx="auto">
                <Button variant="link" onClick={toggleForm} pl={0} pr={0}>
  ...
  const Login = () => {
    ...
    return (
      <Paper>
        ...
        >
          <Grid style={{ marginTop: 20 }} mx="auto">
            <Col span={12} md={6}>
              <TextInput
                autoComplete="off"
                label="Email"
            ...
            <Col span={12}>
              <Center mx="auto">
                <Button pl={0} pr={0} variant="link" onClick={toggleForm}>
